...
API Flickr отвечает в среднем за 2-4 сек. Ответ приходит не сразу. 
Если изображения от API не пришли, то просьба перезагрузить страницу и попробовать ещё раз. Если изображения полностью отсутствуют, есть малая вероятность, что исчерпался лимит API 50-60шт, попробуйте пожалуйста позже.
Тэги соответствуют темам.
Удачи в грядущих войнах!
`);
