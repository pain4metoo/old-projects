export const DATA = {
    navMenu: ['Об игре', 'Викторина', 'Очки', 'Галерея'],
    welcomeInfo: ["Викторина Songbird!", "А как же всё-таки делает птичка? Давай проверим твои знания в этом!", "Правила викторины очень просты:"],
    welcomeRules: ["Вам необходимо прослушать звук и выбрать птицу, которая по вашему мнению соответствует этому звуку.", "В категории 'разминка', вы можете потренироваться. В эту категорию попадают птицы всех видов. На разминке вопросы могут повторяться.", "Результаты полученные на разминке не сохраняются в других категориях, но угаданные птицы отображаются в галерее.", "Чтобы получить очки за пройденную категорию (кроме галереи), вам необходимо завершить раунд.", "Все угаданные птицы отображаются в галерее, после того как вы угадали птицу, вы сможете прочитать полную информацию о ней в галерее.", "В очки идёт лучший результат за всё время.", "Макс. очков за правильный ответ (5 очков), за каждый неправильный ответ отнимается (1 очко) вплоть до 0."],
    category: ['Разминка', 'Воробьиные', 'Лесные', 'Певчие', 'Хищные', 'Морские'],
    birds: [[
        {
            id: 1,
            name: 'Ворон',
    ...
    [
        ...
        },
        {
            ...
            image: 'https://i.ibb.co/L6KgJRz/pelikan.webp',
