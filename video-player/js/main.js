...
console.log(`Первый этап. Повторить исходный проект (10/10)\n
Второй этап. Обязательный дополнительный фукционал (10/10)
Управление плеером с клавиатуры:\n
[x] Клавиша Пробел — пауза +\n
[x] Клавиша M (англ) — отключение/включение звука +\n
[x] Клавиша > — ускорение воспроизведения ролика +\n
[x] Клавиша < — замедление воспроизведения ролика +\n
[x] Клавиша F — включение/выключение полноэкранного режим +\n
Третий этап. Дополнительный функционал на выбор (16)\n
[x] добавить поддержку других горячих клавиш из тех, которые поддерживаются в YouTube видео - 2 балла за каждую дополнительную горячую клавишу. (6/10)\n
[x] Клавиша K (англ) — приостановить или продолжить воспроизведение +\n
[x] Клавиша P (англ) - перейти к предыдущему видео +\n
[x] Клавиша N - перейти к следующему видео +\n
[x] Возможность перелистывания видео (10/10)`);
